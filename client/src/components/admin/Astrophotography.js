    ...
    return (
        <Create title="Create Photo" {...props}>
            <SimpleForm redirect="/astrophotographies">
                ...
                <TextInput source="instrumentUsed" label="instrument Used" validate={required()} />
                <TextInput source="instrumentSettings" label="Instrument Settings" validate={required()} />
                ...
                <ArrayInput source="tags" label="Tags" validate={required()}>
                    <SimpleFormIterator>
                        <SelectInput choices={[
