            ...
            <div className="spinoff container col-10" >
                ...
                <div className="content my-5" style={{ border: "3px solid rgb(41, 123, 176)", padding: "20px", borderRadius: "7px" }}>
                    ...
                    <div
                        ...
                        style={{ marginBottom: "40px", background: "rgb(204, 67, 67)" }}
                    ></div>
                    <p style={{ textAlign: "justify" }}>Founded in 2019 by many technocrats from India's prestigious technical institute Motilal Nehru National Institute of Technology, Allahabad, TSAW envisions transforming humanity through drone-based industry solutions. TSAW is primarily building a healthy drone ecosystem in the country, the "TSAW mobile app," enabling drone renting & services legalising the industry by connecting it to the regulatory body DGCA via proposed UTM (UAV Traffic Management). TSAW also provides enterprise solutions across industries viz., construction, agriculture, public safety, solar & wind energy, etc. Team TSAW is working to achieve a massive reduction in costs & time in hyperlocal logistics using automated UAV technology.
                    </p>
                    ...
                    <p className='my-3' style={{ textAlign: "justify" }}>The establishment of TSAW truly reflects our vision and what we aspire to do, and we hope to be the force for establishment of many such ventures.
                    </p>
                </div>
            </div>
        </>
