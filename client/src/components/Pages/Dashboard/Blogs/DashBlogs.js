          ...
          {user?.blogs?.map((blog) => (
            <Card className="rounded" key={blog._id}>
              ...
              <Accordion.Collapse eventKey={blog._id}>
                <Card.Body>
                  <Tabs activeKey={active} id="uncontrolled-tab-example" onSelect={e => setActive(e)}>
                    <Tab eventKey="view" title="View Blog">
                      {blog.accepted ? (
                        <>
                          <p className='my-4'><strong>
                            Blog has been accepted By :{" "}
                          </strong>
                        ...
                        <>
                          <div id={`preview${blog._id}`} className="my-3">
                            <div
                    ...
                    <Tab eventKey='edit' title='Edit Blog'>
                      <EditBlog blog={blog} setActive={setActive} />
                    </Tab>
                  </Tabs>
                </Card.Body>
              </Accordion.Collapse>
